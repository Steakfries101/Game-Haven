...
async function getGameStores(gameId, back) {
  try {
...
async function loopData(gameName, toTopCreate) {
...
async function backToTopCreate(itemCount) {
  // const toTopElement = document.querySelector(".to-top");
  // const listItems = document.querySelectorAll(".game-list");
