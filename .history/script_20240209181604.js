    ...
    if (game.store_id !== null) {
      ...
      function textDecider(text) {
        ...
        if (text.length > num) {
          ...
          part2Para.style.display = "none"; // Initially hide the second part
          ...
          readMore.addEventListener("click", () => {
            part2Para.style.display = "block"; // Show the second part on "Read More" click
            ...
            readLess.addEventListener("click", () => {
              part2Para.style.display = "none"; // Hide the second part on "Read Less" click
              readMore.style.display = "block"; // Show the "Read More" button
          ...
          gameDesc.appendChild(defaultDesc);
        }
      }
        }
