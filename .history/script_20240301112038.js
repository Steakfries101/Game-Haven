    ...
    if (game.stores !== null) {
      ...
      async function getPlaylist() {
        ...
        if (!playList) {
          ...
          console.log(      `https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&q=${gameName} OST &type=playlist&key=AIzaSyCsEU3Fe6wNACeFTvZQgKA46QnreQL12NI`
          )
        }
      }
